...
public class Visitor extends T5GrammarBaseVisitor<Void> {
    ...
    public Void visitPrograma(T5GrammarParser.ProgramaContext ctx) {
        ...
        for (T5GrammarParser.CmdContext c : ctx.corpo().cmd())
    ...
    public Void visitDeclaracao_local(T5GrammarParser.Declaracao_localContext ctx) {
        ...
        if (ctx.getText().contains("declare")) {
            ...
            if (ctx.variavel().tipo().registro() != null) {
                for (T5GrammarParser.IdentificadorContext ic : ctx.variavel().identificador()) {
                    ...
                    for (T5GrammarParser.VariavelContext vc : ctx.variavel().tipo().registro().variavel()) {
                        tipoVariavel = vc.tipo().getText();
                        for (T5GrammarParser.IdentificadorContext icr : vc.identificador()) {
                ...
                if (tabelaRegistro.containsKey(tipoVariavel)) {
                    ...
                    for (T5GrammarParser.IdentificadorContext ident : ctx.variavel().identificador()) {
            ...
            if (ctx.tipo().registro() != null) {
                ...
                for (T5GrammarParser.VariavelContext vc : ctx.tipo().registro().variavel()) {
                    tipoVariavel = vc.tipo().getText();

                    for (T5GrammarParser.IdentificadorContext ic : vc.identificador()) {
    ...
    public Void visitDeclaracao_global(T5GrammarParser.Declaracao_globalContext ctx) {
        ...
        if (ctx.getText().contains("procedimento")) {
            ...
            for (T5GrammarParser.ParametroContext parametro : ctx.parametros().parametro()) {
                ...
                // Parâmetro de tipo registro definido anteriormente.
                    ...
                    for (T5GrammarParser.IdentificadorContext ic : parametro.identificador())
                        for (int i = 0; i < variaveisRegistro.size(); i += 2)
            ...
            for (T5GrammarParser.CmdContext c : ctx.cmd())    
                if (c.cmdRetorne() != null)  
                    adicionaErroSemantico(c.getStart(), "comando retorne nao permitido nesse escopo");
    ...
    public Void visitCmdLeia(T5GrammarParser.CmdLeiaContext ctx) {
        ...
        tabela = escoposAninhados.obterEscopoAtual();
        for (T5GrammarParser.IdentificadorContext id : ctx.identificador()) 
    ...
    public Void visitCmdEscreva(T5GrammarParser.CmdEscrevaContext ctx) {
        ...
        tabela = escoposAninhados.obterEscopoAtual();
        for (T5GrammarParser.ExpressaoContext expressao : ctx.expressao())
